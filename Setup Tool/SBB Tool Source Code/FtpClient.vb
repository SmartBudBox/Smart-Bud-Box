...
#End Region
        ...
        Public Function OrdnerUpload(ByVal strSource As String, ByVal strTarget As String) As Boolean
            ...
            Using mySession As Session = New Session
                ...
                ' Upload files
                mySession.PutFiles(strSource & "\*", strTarget & "/").Check()
            End Using
        End Function
...
#Region "private supporting fns"
        ...
        Private Function GetDirectory(Optional ByVal directory As String = "") As String
            ...
            Else
                ...
                _lastDirectory = directory.Substring(1)
            End If
            Return URI
        End Function

        'stores last retrieved/set directory
        Public _lastDirectory As String = ""
